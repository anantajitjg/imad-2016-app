var ArticleTemplate=function(){
    ...
    me.create=function(dataObj){
        ...
        <body>
            <div id="wrapper">
                <div class="float_right"><span id="user_area"><button id="login_btn" class="btn_primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Login</button></span>&nbsp;&nbsp;<button id="home_trigger" class="btn_primary responsive_btn"><span class="glyphicon glyphicon-home" aria-hidden="true"></span><span class="responsive_text">Home</span></button></div>
    ...
    me.loginTemplate=function(){
        var template=`<div id="login" class="loginInnerWrapper">
                ...
                <form id="login_form" action="#" method="POST">
                    <div class="flex_table">             
                            <div class="row">
                                <div class="field">Username:</div><div class="field"><input type="text" name="un" id="login_un" maxlength="25" placeholder="Username" required /></div>
                            </div>
                            <div class="row">
                                    <div class="field">Password:</div><div class="field"><input type="password" name="pwd" id="login_pwd" placeholder="Password" required /></div>
                            </div>
                            <div class="row">
                                <div class="field colspan"><input type="submit" id="login_submit" value="Login" class="btn_primary span_elem" /></div>
                            </div>
                    </div>
                </form> 
            </div>
            <div id="register" class="loginInnerWrapper">
                ...
                <form id="register_form" action="#" method="POST">
                    <div class="flex_table">
                            <div class="row">
                                <div class="field">Username:</div><div class="field"><input type="text" name="un" id="register_un" maxlength="25" placeholder="Username" required /></div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="field colspan"><input type="submit" id="register_submit" value="Register" class="btn_primary span_elem" /></div>
                            </div>
                    </div>
                </form>
            </div>`;
